...
client = MongoClient(host='mongodb://test:test@52.79.104.68/?authSource=admin', port=27017)
...
def user_page():
    token = request.form['access-token']
    ...
    return render_template('user_page.html', user=user, comments=comments, pic=pic, token=token   )
